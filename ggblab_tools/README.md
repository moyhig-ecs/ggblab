ggblab_tools — Proxy Jupyter kernel
=================================
...
```bash
python -m ggblab_tools.console_frontend
# or directly:
...
Notes
-----
- The proxy kernel is implemented in `ggblab_tools/proxy_kernel.py` and started via `python -m ggblab_tools.proxy_launcher`.
