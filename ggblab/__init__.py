...
the control socket). No ipywidgets. Conventions: C0-A control channel (kernel side only); C1 host verbs = a closed subset of the GeoGebra Apps API (7 on 2026-09-07: writes eval/new/delete/xml_in, reads xml_out/value, subscription listen); C2 never rely
