...
transport = mailbox (RPC); C1 host verbs = a closed subset of the GeoGebra Apps API (8 on 2026-09-09: writes eval/new/delete/xml_in, reads xml_out/value/kind, subscription listen); C2 never rely
