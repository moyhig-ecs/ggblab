...
- If non-Python kernel support is desired, implement additional _kernels_ (e.g., Julia, R) via separate language-specific packages, not by switching the reference implementation
