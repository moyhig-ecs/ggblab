...
from ggblab.ggbapplet import (GeoGebra, GeoGebraSemanticsError,
                              GeoGebraSyntaxError)
...
class TestSyntaxValidation:
    ...
    def test_syntax_error_raised(self):
        ...
        async def run_test():
            ...
            ggb.parser.tokenize_with_commas = MagicMock(
...
class TestSemanticExceptionAttributes:
    ...
    def test_semantic_error_attributes(self):
        ...
        error = GeoGebraSemanticsError(
            "Circle[A, C]", "Objects not found", missing_objects=["C"]
        )
    ...
    def test_semantic_error_default_missing_objects(self):
        ...
        error = GeoGebraSemanticsError("Command", "Error message")
